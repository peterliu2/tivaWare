//
// "$Id: Fl_Type.h 6012 2008-01-04 21:45:49Z matt $"
//
...
public:
    ...
    virtual const char *type_name()
    {
        return tabs_type_name;
    }
    Fl_Widget *widget(int X,int Y,int W,int H)
    {
        itabs *g = new itabs(X,Y,W,H);
        Fl_Group::current(0);
        return g;
    }
    Fl_Widget_Type *_make()
    {
        return new Fl_Tabs_Type();
    }
...
class Fl_Scroll_Type : public Fl_Group_Type
{
    Fl_Menu_Item *subtypes()
    {
        return scroll_type_menu;
    }
public:
    virtual const char *type_name()
    {
        return scroll_type_name;
    }
    Fl_Widget_Type *_make()
    {
        return new Fl_Scroll_Type();
    }
    int pixmapID()
    {
        return 19;
...
public:
    virtual const char *type_name()
    {
        return wizard_type_name;
    }
    Fl_Widget *widget(int X,int Y,int W,int H)
    {
        iwizard *g = new iwizard(X,Y,W,H);
        Fl_Group::current(0);
        return g;
    }
    Fl_Widget_Type *_make()
    {
        return new Fl_Wizard_Type();
    }
    int pixmapID()
    {
        return 21;
...
public:
    ...
    int is_button() const
    {
        return 1;   // this gets shortcut to work
    }
    Fl_Widget* widget(int,int,int,int)
    {
        return 0;
...
public:
    ...
    {
        parent->add_child(a,b);
    }
    void move_child(Fl_Type*a, Fl_Type*b)
    {
        parent->move_child(a,b);
    }
...
public:
    ...
    Fl_Widget_Type *_make()
    {
        return new Fl_Menu_Button_Type();
    }
    int pixmapID()
    {
        return 26;
...
public:
    ...
    Fl_Widget_Type *_make()
    {
        return new Fl_Input_Choice_Type();
    }
    virtual void build_menu();
    int pixmapID()
    {
...
//
// End of "$Id: Fl_Type.h 6012 2008-01-04 21:45:49Z matt $".
//
